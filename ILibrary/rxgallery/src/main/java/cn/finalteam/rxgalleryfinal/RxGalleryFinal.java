...
public class RxGalleryFinal {
    ...
    /**
     * @deprecated Use {@link #mediaType(int)} instead
     */
    @Deprecated
    public RxGalleryFinal image() {
         ...
         * @since 1.1.0
         */
        configuration.setMediaType(Configuration.MEDIA_TYPE_IMAGE);
        return this;
    }
    ...
    public RxGalleryFinal video() {
         ...
         * @since 1.1.0
         */
        configuration.setMediaType(Configuration.MEDIA_TYPE_VIDEO);
        return this;
    }
     ...
     * 设置要展示的媒体文件类型
     *
     * @param mediaType 可传参数有：
     *                  <p>图片类型：{@link Configuration#MEDIA_TYPE_IMAGE}</p>
     *                  <p>视频类型：{@link Configuration#MEDIA_TYPE_VIDEO}</p>
     *                  <p>图片和视频类型：{@link Configuration#MEDIA_TYPE_IMAGE_AND_VIDEO}</p>
     * @since 1.1.0
     */
    public RxGalleryFinal mediaType(int mediaType) {
