...
public class MediaGridPresenterImpl implements MediaGridPresenter, MediaSrcFactoryInteractor.OnGenerateMediaListener,
     ...
     * @since 1.1.0
     */
    public MediaGridPresenterImpl(Context context) {
        this.context = context;
        this.mediaSrcFactoryInteractor = new MediaSrcFactoryInteractorImpl(context, this);
        this.mediaBucketFactoryInteractor = new MediaBucketFactoryInteractorImpl(context, this);
    }

    /**
     * @deprecated Use {@link #MediaGridPresenterImpl(Context)} instead
     */
    @Deprecated
    ...
    @Deprecated
    @Override
    public void getImageList(String bucketId, int pageSize, int currentOffset) {
        mediaSrcFactoryInteractor.generateImages(bucketId, pageSize, currentOffset);
    }
     ...
     */
    @Override
    public void getImageAndVideoList(String bucketId, int pageSize, int currentOffset) {
        mediaSrcFactoryInteractor.generateImagesAndVideos(bucketId, pageSize, currentOffset);
    }
    ...
    @Deprecated
    @Override
    public void getBucketWithImageOrVideoList() {
        mediaBucketFactoryInteractor.generateBucketsWithImageOrVideo();
    }
     ...
     */
    @Override
    public void getBucketWithImageAndVideoList() {
        mediaBucketFactoryInteractor.generateBucketsWithImageAndVideo();
    }
