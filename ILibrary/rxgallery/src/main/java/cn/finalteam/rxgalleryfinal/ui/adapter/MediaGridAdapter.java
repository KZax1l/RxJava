...
//        this.mImageViewBg = ThemeUtils.resolveDrawable(mMediaActivity, R.attr.gallery_imageview_bg, R.drawable.gallery_default_image);
        this.mCameraImage = ThemeUtils.resolveDrawable(mMediaActivity, R.attr.gallery_camera_bg, R.drawable.gallery_ic_camera);
    ...
    public void onBindViewHolder(GridViewHolder holder, int position) {
        ...
        if (mediaBean.getId() == Integer.MIN_VALUE) {
             ...
             * 视频类型文件不能多选
             */
//            if (!mConfiguration.isRadio() && mediaBean.getMediaType() != MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO) {
...
//            }
            ...
            if (mediaBean.getMediaType() == MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO) {
                ...
                holder.mTvDuration.setText(mediaBean.getDuration());
            } else {
