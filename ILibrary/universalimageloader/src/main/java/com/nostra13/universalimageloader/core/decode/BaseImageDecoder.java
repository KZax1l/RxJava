...
public class BaseImageDecoder implements ImageDecoder {
     ...
     * 根据{@code 解码系数}{@link ImageDecodingInfo}获取图片数据流、缩放系数、续传位置等信息解码成Bitmap
     *
    ...
    protected ImageFileInfo defineImageSizeAndRotation(InputStream imageStream, ImageDecodingInfo decodingInfo)
        ...
        /**
         * 由于inJustDecodeBounds设置为true，它会返回一个null的Bitmap，但是可以获取到outWidth，outHeight与outMimeType
         */
    ...
    /**
     * 若图片的MIME类型为image/jpeg且路径地址类型为{@link Scheme#FILE}，则返回true
     */
    ...
    /**
     * 根据ExifInterface读取图片的旋转度数和图片是否进行了翻转，返回一个ExifInfo对象
     */
    ...
    /**
     * 设置{@link BitmapFactory.Options#inSampleSize}的值，即缩放比例系数
     * 注：前提是{@link ImageScaleType}为{@link ImageScaleType#NONE}、{@link ImageScaleType#NONE_SAFE}或{@link ImageScaleType#IN_SAMPLE_POWER_OF_2}
     */
    ...
    /**
     * 根据{@link ImageDecodingInfo}对图片进行缩放翻转或旋转操作
     * 注：{@link BaseImageDecoder#prepareDecodingOptions}做了部分{@link ImageScaleType}的处理
     * 所以这里只对{@link ImageScaleType}为{@link ImageScaleType#EXACTLY}和{@link ImageScaleType#EXACTLY_STRETCHED}进行处理
     */
