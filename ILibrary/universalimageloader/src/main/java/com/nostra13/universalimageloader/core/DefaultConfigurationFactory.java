...
public class DefaultConfigurationFactory {
     ...
     * <p>
     * 创建磁盘缓存（通常是在SD卡的/Android/data/[app_package_name]/cache/uil-images目录下）
     */
     ...
     * 创建缓存目录（通常是SD卡的/Android/data/[app_package_name]/cache/uil-images目录）
     */
