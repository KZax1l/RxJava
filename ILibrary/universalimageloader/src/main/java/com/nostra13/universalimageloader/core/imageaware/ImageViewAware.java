...
public class ImageViewAware extends ViewAware {
    ...
    /**
     * 设置ImageView的图片文件，若该图片文件为动画的，则同时进行播放
     *
     * @param drawable
     * @param view
     */
    ...
    private static int getImageViewFieldValue(Object object, String fieldName) {
        ...
        try {
            ...
            field.setAccessible(true);//因为该field字段为私有字段（private），所以必须加上这句，否则会报错
            int fieldValue = (Integer) field.get(object);//返回指定对象上此 Field 表示的字段的值
