...
public class SpinnersFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.sample_fragment_spinner, container, false);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(), R.layout.sample_row_spn, items);
        adapter.setDropDownViewResource(R.layout.sample_row_spn_dropdown);
