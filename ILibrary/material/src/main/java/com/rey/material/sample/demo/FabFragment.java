...
public class FabFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.sample_fragment_fab, container, false);
        ...
        mDrawables[0] = v.getResources().getDrawable(R.drawable.sample_ic_autorenew_white_24dp);
        mDrawables[1] = v.getResources().getDrawable(R.drawable.sample_ic_done_white_24dp);
