package com.rey.material.sample.demo;
...
public class DialogsFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sample_fragment_dialog, container, false);
    ...
    private void showBottomSheet() {
        ...
        View v = LayoutInflater.from(mActivity).inflate(R.layout.sample_view_bottomsheet, null);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.dialog_bt_title_only) {
        ...
        } else if (v.getId() == R.id.dialog_bt_msg_only) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
            ...
            ((SimpleDialog.Builder) builder).message("Delete this conversation?")
                    ...
                    .negativeAction("CANCEL");
        } else if (v.getId() == R.id.dialog_bt_title_msg) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
        ...
        } else if (v.getId() == R.id.dialog_bt_custom) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
            ...
            builder.title("Google Wi-Fi")
                    ...
                    .negativeAction("CANCEL")
                    .contentView(R.layout.sample_layout_dialog_custom);
        } else if (v.getId() == R.id.dialog_bt_choice) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
            ...
            ((SimpleDialog.Builder) builder).items(new String[]{"None", "Callisto", "Dione", "Ganymede", "Hangouts Call", "Luna", "Oberon", "Phobos"}, 0)
                    ...
                    .positiveAction("OK")
                    .negativeAction("CANCEL");
        } else if (v.getId() == R.id.dialog_bt_multi_choice) {
            builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog) {
                @Override
                public void onPositiveActionClicked(DialogFragment fragment) {
            ...
            ((SimpleDialog.Builder) builder).multiChoiceItems(new String[]{"Soup", "Pizza", "Hotdogs", "Hamburguer", "Coffee", "Juice", "Milk", "Water"}, 2, 5)
                    ...
                    .positiveAction("OK")
                    .negativeAction("CANCEL");
        } else if (v.getId() == R.id.dialog_bt_time) {
            ...
            builder.positiveAction("OK")
                    .negativeAction("CANCEL");
        } else if (v.getId() == R.id.dialog_bt_date) {
