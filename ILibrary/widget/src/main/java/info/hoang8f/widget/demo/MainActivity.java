package info.hoang8f.widget.demo;
...
public class MainActivity extends ActionBarActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sample_fbutton_main, menu);
        return true;
    }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.change_color_button){
            //Create color picker view
            View view = this.getLayoutInflater().inflate(R.layout.sample_fbutton_color_picker_dialog, null);
            if (view == null) return;
