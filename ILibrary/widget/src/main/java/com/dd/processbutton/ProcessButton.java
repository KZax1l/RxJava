...
public abstract class ProcessButton extends FButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_rect_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_rect_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_rect_error).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int purple = getColor(R.color.process_button_purple_progress);
