...
import com.dd.CircularProgressFButton;
...
public class Sample1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_cpb_ac_sample_1);

        ActionBar actionBar = getActionBar();
        if (actionBar != null) {
            actionBar.setTitle(R.string.sample_cpb_IndeterminateProgressSample);
        }
        ...
        final CircularProgressFButton circularButton2 = (CircularProgressFButton) findViewById(R.id.circularButton2);
