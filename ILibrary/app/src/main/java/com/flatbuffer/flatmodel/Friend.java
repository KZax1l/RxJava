...
public final class Friend extends Table {
    public static Friend getRootAsFriend(ByteBuffer _bb) {
        return getRootAsFriend(_bb, new Friend());
    }

    public static Friend getRootAsFriend(ByteBuffer _bb, Friend obj) {
        _bb.order(ByteOrder.LITTLE_ENDIAN);
        return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb));
    }

    public Friend __init(int _i, ByteBuffer _bb) {
        bb_pos = _i;
        bb = _bb;
        return this;
    }
    ...
    public static int createFriend(FlatBufferBuilder builder, long id, int nameOffset) {
    ...
    public static void startFriend(FlatBufferBuilder builder) {
        builder.startObject(2);
    }
