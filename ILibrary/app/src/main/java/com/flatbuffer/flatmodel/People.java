...
public final class People extends Table {
    public static People getRootAsPeople(ByteBuffer _bb) {
        return getRootAsPeople(_bb, new People());
    }

    public static People getRootAsPeople(ByteBuffer _bb, People obj) {
        _bb.order(ByteOrder.LITTLE_ENDIAN);
        return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb));
    }

    public People __init(int _i, ByteBuffer _bb) {
        bb_pos = _i;
        bb = _bb;
        return this;
    }
    ...
    public ByteBuffer guidAsByteBuffer() {
    ...
    public ByteBuffer companyAsByteBuffer() {
    ...
    public static void startPeople(FlatBufferBuilder builder) {
        builder.startObject(8);
    }
    ...
    public static void addIndex(FlatBufferBuilder builder, long index) {
        builder.addLong(1, index, 0);
    }

    public static void addGuid(FlatBufferBuilder builder, int guidOffset) {
        builder.addOffset(2, guidOffset, 0);
    }
    ...
    public static void addCompany(FlatBufferBuilder builder, int companyOffset) {
        builder.addOffset(5, companyOffset, 0);
    }

    public static void addEmail(FlatBufferBuilder builder, int emailOffset) {
        builder.addOffset(6, emailOffset, 0);
    }
