...
public class PieChartActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        protected String[] mParties = new String[]{
                "限速60KM/H（包含）以内，校车超速20%以下", "不按导向车道行驶", "中型车超速20%以上60%以下",
                "超速10%一下", "逆行", "未知", "未知", "闯红灯", "压线", "未知", "中型车超速20%"
        };
        protected float[] mValues = {1, 602, 83, 1, 838, 3, 1, 507, 11477, 265, 44};
...
//                SliceValue sliceValue = new SliceValue((float) Math.random() * 30 + 15, ChartUtils.pickColor());
                SliceValue sliceValue = new SliceValue(mValues[i], ChartUtils.pickColor());
                sliceValue.setLabel(mParties[i]);
